 ...
 */
export const testNode = <ThrowOnError extends boolean = false>(options: Options<TestNodeData, ThrowOnError>): RequestResult<TestNodeResponses, TestNodeErrors, ThrowOnError> => (options.client ?? client).post<TestNodeResponses, TestNodeErrors, ThrowOnError>({ url: '/flows/{flow_uid}/nodes/{node_id}/test', ...options });
